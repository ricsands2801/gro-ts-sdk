...
- <code><a href="./src/resources/api-json.ts">APIJsonRetrieveResponse</a></code>

Methods:

- <code title="get /api.json">client.apiJson.<a href="./src/resources/api-json.ts">retrieve</a>() -> string</code>

# APIYaml

Types:

- <code><a href="./src/resources/api-yaml.ts">APIYamlRetrieveResponse</a></code>

Methods:

- <code title="get /api.yaml">client.apiYaml.<a href="./src/resources/api-yaml.ts">retrieve</a>() -> string</code>
